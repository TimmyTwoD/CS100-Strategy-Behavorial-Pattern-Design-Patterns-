...
class Spreadsheet
{
    std::vector<std::string> column_names; // vector of strings that hold column names
    std::vector<std::vector<std::string> > data; // vector of a vector of strings which hold data
